  ...
  return (
    ...
    <> 
      ...
      <div className={`fixed inset-y-0 left-0 transform  ${sidebar ? "translate-x-0" : "-translate-x-full"} transition-transform duration-200 ease-in-out bg-gray-300	 py-10 w-64 min-h-screen z-20 `}>
        <div className='mb-10'>
        <div>
          <Image src={require("../../../public/jobz.png")} width={40} height={30} className='absolute top-4  p-1' />
        </div>
        <div>
        ...
        <ul className='flex flex-col text-blue-800 '>
          ...
          <div className='bg-gray -100 text-xl font-bold inline-flex items-center px-4 py-2 transition w-full ' >
                        ...
                        <li>
                            <a className='bg-gray -100 font-bold inline-flex items-center px-4 py-2 transition w-full hover:bg-gray-100' href="/Opportunities">
                                <span className='text-red-800  mr-2 ml-0.5'><svg xmlns="http://www.w3.org/2000/svg" width="20" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-home"><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg></span> <span className='mt-1'>Opportunities</span> </a>
                    
                        </li>
                        <li>
                            <a className='bg-gray -100 font-bold inline-flex items-center px-4 py-2 transition w-full hover:bg-gray-100' href="/Skills">
                                <span className='text-red-800  mr-2 ml-0.5'><svg xmlns="http://www.w3.org/2000/svg" width="20" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-home"><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg></span> <span className='mt-1'>   <nav>Necessary Skills</nav></span> </a>
                    
                        </li>
                        <li  >
                            <a className='bg-gray -100 font-bold inline-flex items-center px-4 py-2 transition w-full hover:bg-gray-100' href="/">
